...
class TestDetectPendingRelay(TestCase):
    ...
    def test_ok_detect_pending_relay(self, mock_notify_pending_relays, mock_get_apply_relay_event_logs, mock_get_relay_event_logs):
        # Setup mock
        mock_get_relay_event_logs.return_value = mock_relay_log.data
        mock_get_apply_relay_event_logs.return_value = mock_apply_relay_log.data
